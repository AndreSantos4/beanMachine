...
const products = [
  ...
  { id: 4, name: 'Sumo Tropical', category: 'drink', price: 50, menuAllowed: ['brunch', 'lunch'], ingredients: ['Água','Gasosa','Gelo','Leite','Manga', 'Hortelã'], img:'https://i.ibb.co/0yzQG38M/Sumo-Tropical.png' },
...
function searchProducts() {
  ...
  if (query === '') {
    ...
    // Filtrar produtos que contenham o termo de pesquisa no nome
